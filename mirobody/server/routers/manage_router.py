...
from ..manage.service import ManageService
from ..manage.auth import verify_manage_key
from ..manage.user_health import UserHealthDataService
...
async def get_units_info(authorized: bool = Depends(verify_manage_key)):
    ...
    """
    try:
        from ...pulse.standardize import get_all_units_info
...
async def get_indicators_and_units(authorized: bool = Depends(verify_manage_key)):
    ...
    """
    try:
        from ...pulse.standardize import get_all_indicators_info, get_all_units_info
...
async def recalculate_date_range(
    ...
    """
    try:
        from ...pulse.aggregate.service import AggregateIndicatorService
        from datetime import datetime
...
async def get_ingestion_stats(
    ...
    """
    try:
        from ...pulse.monitor.query_service import MonitorQueryService
...
async def trigger_backfill(
    ...
    """
    try:
        from ...pulse.monitor.collector_service import MonitorCollectorService
...
async def get_aggregation_status(
    ...
    """
    try:
        from ...pulse.aggregate.startup import get_aggregate_task_full_status
        from ...pulse.monitor.startup import get_hourly_task_full_status, get_daily_task_full_status
...
async def get_aggregation_coverage(
    ...
    """
    try:
        from ...pulse.monitor.coverage_service import CoverageService
...
async def get_user_profile(
    ...
    """
    try:
        from ...pulse.monitor.user_profile_service import UserProfileService
...
async def run_insight_engine(
    ...
    """
    try:
        from ...pulse.insight.engine_task import InsightEnginePullTask
...
async def eval_insight(
    ...
    try:
        ...
        from ...pulse.insight.eval_agent import EvalAgent
...
async def get_std_indicator_registry_status(authorized: bool = Depends(verify_manage_key)):
    ...
    """
    try:
        from ...pulse.standardize.std_indicator_registry.startup import get_std_indicator_registry_full_status
