...
COMMENT ON COLUMN th_series_data.full_dim_id IS '关联 indicator_full_dim 表的ID';
COMMENT ON COLUMN th_series_data.fhir_id IS 'FHIR标准指标ID，来自 indicator_full_dim.fhir_id';
