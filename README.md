...
| Your coding agent to stop guessing about a lab report | Copy [`skills/dont-guess-my-labs/`](skills/dont-guess-my-labs/) into Claude Code, Codex or OpenClaw — it needs `pip install mirobody` and no key | [`SKILL.md`](skills/dont-guess-my-labs/SKILL.md) |
