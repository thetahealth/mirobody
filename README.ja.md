...
- UCUMファミリー(約310)への**単位正規化**、および
  ...
  るモル質量ブリッジ、`%` と `10*9/L` に対する明示的な変換拒否。標準pulse指標300種。
- ルートカテゴリ5種(人口統計、身体測定、バイタルサイン、生活習慣と社会、臨床検査)
  計25ラベルのタキソノミー ―― 臨床検査配下の11の身体系統は同列ではなく子だ。
...
デプロイ方法、APIプラットフォーム、そしてこのオープンソースエンジンを扱う。3つとも進化し
ながら同期が保たれている。
