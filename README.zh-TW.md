...
<a href="https://github.com/thetahealth/mirobody/stargazers">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="docs/images/star-history-dark.zh-TW.svg" />
    <source media="(prefers-color-scheme: light)" srcset="docs/images/star-history.zh-TW.svg" />
    <img alt="Star 趨勢圖" src="docs/images/star-history.zh-TW.svg" />
  </picture>
</a>
</div>
