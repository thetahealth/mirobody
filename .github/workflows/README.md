...
**Features**:
- Test build on the supported Python versions (3.12, 3.13)
...
> 💡 Release notes are generated by GitHub's built-in `generate_release_notes` — write clear PR titles and they become the notes.
